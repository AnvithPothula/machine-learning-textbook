...
<iframe src="../../sims/network-architecture-visualizer/main.html" width="100%" height="750" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>

[View Fullscreen](../../sims/network-architecture-visualizer/main.html){: target="_blank" .md-button } | [Documentation](../../sims/network-architecture-visualizer/index.md)

## Interactive Visualization: Activation Functions

Compare different activation functions and their properties:

<iframe src="../../sims/activation-functions/main.html" width="100%" height="850" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>

[View Fullscreen](../../sims/activation-functions/main.html){: target="_blank" .md-button } | [Documentation](../../sims/activation-functions/index.md)
