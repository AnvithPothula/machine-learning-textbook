...
- Implementation exercises in Python
...
[View the Learning Graph →](learning-graph/index.md)

## Getting Started

1. Review the [Course Description](course-description.md)
2. Explore the [Learning Graph](learning-graph/index.md)
